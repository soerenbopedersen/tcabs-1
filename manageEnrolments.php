...
<html lang="en">
  ...
  <body class="loggedin">
		...
		<a type="button"  href="forms/addEnrolment.php" class="btn btn-primary btn-lg btn-block">Add Enrolment</a>
		<a type="button"  href="forms/updateEnrolments.php" class="btn btn-primary btn-lg btn-block">Update or Delete Enrolment</a>
		<a type="button"  href="forms/csvEnrolment.php" class="btn btn-primary btn-lg btn-block">Bulk Import via CSV</a>
