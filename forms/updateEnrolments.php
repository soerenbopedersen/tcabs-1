...
<?php
	...
	if (!isset($_SESSION['logged_in'])) {
		...
		// if there was a post request
			...
			$searchResults = [
    'John Smith'  => 'IT Project Management - HS1 2019',
	'Jane Citizen'  => 'Networks & Switching - HS1 2019',
];
		}
?>
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
		...
		<title>Update/Delete Unit Offerings - TCABS</title>
  </head>
  ...
  <body class="loggedin">
		...
		<div class="content">
			<h2>Manage Enrolments > Update/Delete Enrolments</h2><h2-date><?php echo date('d F, Y (l)'); ?></h2-date><br>
			<div>
		<?php 
		...
		?>
			<!-- Show Search Form -->
				<form style="width: 90%; margin: auto;" action="updateEnrolments.php" method ="post" class="was-validated">
		<br>
  	  <p class="h4 mb-4 text-center">Update/Delete Enrolments</p>

  <input type="text" id="searchQuery" name="searchQuery" class="form-control" placeholder="Enter Unit Name/Code or Username/Student Name" required>
	...
	?>			
		<div>
<form action="updateEnrolments.php" method="post">
	 <table style="width: 100%;">

<tr>
    <th style="width: 40%;">Student Name</th>
	<th style="width: 35%;">Unit Name / Teaching Period</th>
