...
<?php
	...
	if (!isset($_SESSION['logged_in'])) {
		...
		// if there was a post request
			...
			$searchResults = [
    'INF30029'  => 'IT Project Management',
	'TNE10006'  => 'Networks & Switching',
];
		}
?>
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
		...
		<title>Update/Delete Units - TCABS</title>
  </head>
  ...
  <body class="loggedin">
		...
		<div class="content">
			<h2>Manage Users > Update/Delete Units</h2><h2-date><?php echo date('d F, Y (l)'); ?></h2-date><br>
			<div>
		<?php 
		...
		<br>
  	  <p class="h4 mb-4 text-center">Update/Delete Units</p>

  <input type="text" id="searchQuery" name="searchQuery" class="form-control" placeholder="Enter Unit Name or Email" required>
	...
	?>			
		<div>
<form action="updateUnits.php" method="post">
