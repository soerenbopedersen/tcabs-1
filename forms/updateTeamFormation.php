...
<?php
	...
	if (!isset($_SESSION['logged_in'])) {
		...
		// if there was a post request
			...
			$searchResults = [
    'The A Team'  => 'Database Implementation - HS1 2019',
	'The Coders'  => 'Intro to Programming - HS1 2019',
];
		}
?>
...
<html lang="en">
  <head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
		...
		<title>Update/Delete Team Formation - TCABS</title>
  </head>
  ...
  <body class="loggedin">
		...
		<div class="content">
			<h2>Manage Teams > Update/Delete Team Formation</h2><h2-date><?php echo date('d F, Y (l)'); ?></h2-date><br>
			<div>
		<?php 
		...
		?>
			<!-- Show Search Form -->
				<form style="width: 90%; margin: auto;" action="updateTeam.php" method ="post" class="was-validated">
		<br>
  	  <p class="h4 mb-4 text-center">Update/Delete Team Formation</p>
