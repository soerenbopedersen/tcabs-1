...
<html lang="en">
  <head>
    ...
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
		...
		<title>Add Enrolment - TCABS</title>
  </head>
  ...
  <body class="loggedin">
		...
		<div class="content">
			<h2>Manage Enrolments > Add Enrolment</h2><h2-date><?php echo date('d F, Y (l)'); ?></h2-date><br>
			<div>
		<?php 
  	  ...
  	  <p class="h4 mb-4 text-center">Add Enrolment</p>
			...
			<select class="browser-default custom-select" id="username" name="username" required>
...
<br><br>
  		<button class="btn btn-info my-4 btn-block" type="submit">Add Enrolment</button>
		</form>
