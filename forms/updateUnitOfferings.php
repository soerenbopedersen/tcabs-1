...
<?php
	...
	if (!isset($_SESSION['logged_in'])) {
		...
		// if there was a post request
			...
			$searchResults = [
    'INF30029'  => 'IT Project Management - HS1 2019',
	'TNE10006'  => 'Networks & Switching - HS1 2019',
];
		}
?>
...
<html lang="en">
  ...
  <body class="loggedin">
		...
		<div class="content">
			<h2>Manage Unit Offerings > Update/Delete Offerings</h2><h2-date><?php echo date('d F, Y (l)'); ?></h2-date><br>
			<div>
		<?php 
		...
		?>
			<!-- Show Search Form -->
				<form style="width: 90%; margin: auto;" action="updateUnitOfferings.php" method ="post" class="was-validated">
		<br>
  	  <p class="h4 mb-4 text-center">Update/Delete Unit Offerings</p>
  ...
  <input type="text" id="searchQuery" name="searchQuery" class="form-control" placeholder="Enter Unit Name or Code" required>
	...
	?>			
		<div>
<form action="updateUnitOfferings.php" method="post">
