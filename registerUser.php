...
<?php include "header.php"; ?>
  ...
  <body class="loggedin">
	...
	<a href="bulkImportUser.php"><p class="p text-center">or bulk import</p></a>
	<br>
	...
	<br>
	<br>
    <input type="text" id="pNum" class="form-control" placeholder="Phone number" aria-describedby="defaultRegisterFormPhoneHelpBlock" required>
	<br>
    <input type="email" id="email" class="form-control" placeholder="E-mail" required>
	<br>
    <input type="password" id="pwd" class="form-control" placeholder="Password" aria-describedby="defaultRegisterFormPasswordHelpBlock" required>
	<br>
