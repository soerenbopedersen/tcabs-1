...
<html lang="en">
  ...
  <body class="loggedin">
		...
		<a type="button"  href="forms/addProject.php" class="btn btn-primary btn-lg btn-block">Add Project</a>
		<a type="button"  href="forms/updateProjects.php" class="btn btn-primary btn-lg btn-block">Update or Delete Project</a>
